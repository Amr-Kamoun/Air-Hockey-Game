...
void keyInput(unsigned char key, int x, int y) {
    if (inMenu) {
        ...
        switch (key) {
            case 'w':
            case 'W':
                if (player1.y < 0.4) player1.y += 0.05f; //Movement of Player 1
                break;
            case 's':
            case 'S':
...
//Movement of Paddle of Player 2
